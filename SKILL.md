...
- `POST /v1/mesh/az-generator` — local AZ-GENERATOR-1.0 law (7m77s = 497s, Cap-7, first claim `www.survivalnetwork.az`, ≥49 papers in the local vault). Not a Softwares-tab product.
