 ...
 *
 * GET  /download?repo=AzielEliab/miragegrid&tag=latest&asset=...
 ...
 * Isolated counter: Worker miragegrid-download-tracker, project miragegrid.
...
async function githubStats(env) {
  ...
  const headers = { "User-Agent": "Mozilla/5.0 MirageGrid-download-tracker", Accept: "application/vnd.github+json" };
  let stars = 0;
  let forks = 0;
  let watchers = 0;
  let release_download_count = 0;
  try {
    const repoRes = await fetch("https://api.github.com/repos/AzielEliab/miragegrid", { headers });
    if (repoRes.ok) {
    ...
    const relRes = await fetch("https://api.github.com/repos/AzielEliab/miragegrid/releases/latest", { headers });
    if (relRes.ok) {
...
# MirageGrid one-click install. Counted download via this Worker.
set -euo pipefail
HOST="${HOST}"
ASSET="${DEFAULT_ASSET}"
...
<meta name="description" content="Static pool of 25 named logical nodes by Aziel Eliab; not a VPN, proxy, or Tor hop.">
<meta name="author" content="Aziel Eliab">
<link rel="canonical" href="https://miragegrid-download-tracker.vibelock.workers.dev/">
<meta property="og:title" content="MirageGrid — Aziel Eliab">
<meta property="og:description" content="Static pool of 25 named logical nodes by Aziel Eliab; not a VPN, proxy, or Tor hop.">
<meta property="og:url" content="https://miragegrid-download-tracker.vibelock.workers.dev/">
...
<script type="application/ld+json">
{
  ...
  "codeRepository": "https://github.com/AzielEliab/miragegrid",
  "downloadUrl": "https://miragegrid-download-tracker.vibelock.workers.dev/download",
  "license": "https://www.apache.org/licenses/LICENSE-2.0",
  "url": "https://miragegrid-download-tracker.vibelock.workers.dev/",
  "description": "Static pool of 25 named logical nodes by Aziel Eliab; not a VPN, proxy, or Tor hop."
}
</script>
<!-- gitbaby-seo -->
<style>
...
<body>
  ...
  <div class="card">
    ...
    <p class="kid"><strong>Two big buttons.</strong> Download saves the gzip (the Downloads number goes up). One-click install copies a Terminal command. After it finishes, type <code>miragegrid ui</code>.</p>
    <div class="btns">
...
<section class="cite" id="cite">
  <h2>How to cite</h2>
  <p>Aziel Eliab. MirageGrid. https://github.com/AzielEliab/miragegrid. https://miragegrid-download-tracker.vibelock.workers.dev.</p>
  <p><a href="https://aziel-runtime.vibelock.workers.dev/">Catalog</a> · <a href="https://github.com/AzielEliab/miragegrid">GitHub</a> · <a href="https://miragegrid-download-tracker.vibelock.workers.dev/download">Download</a> · <a href="https://miragegrid-download-tracker.vibelock.workers.dev/cite.json">cite.json</a></p>
</section>
<!-- /gitbaby-seo -->
</body>
</html>`;
...
export default {
  async fetch(request, env) {
    ...
    if ((url.pathname === "/cite.json" || url.pathname === "/cite.json/") && request.method === "GET") {
      return json({"author": "Aziel Eliab", "title": "MirageGrid", "github": "https://github.com/AzielEliab/miragegrid", "download": "https://miragegrid-download-tracker.vibelock.workers.dev/download", "doi": null, "license": "Apache-2.0", "catalog": "https://aziel-runtime.vibelock.workers.dev/"});
    }
    // /gitbaby-seo-routes
