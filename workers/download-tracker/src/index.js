...
<body>
  <h1>MirageGrid</h1>
  <p class="motto">Logical identities and receipts. Not a network.</p>
  <div class="card">
    <p class="count">${n}<span> downloads of this project</span></p>
    <a class="dl" href="/download?asset=miragegrid-0.1.0.tar.gz">Download miragegrid-0.1.0.tar.gz — ${n} counted</a>
    ...
    <p class="iso">Isolated counter: Worker <code>miragegrid-download-tracker</code>, project <code>miragegrid</code>. Not mixed with any other product.</p>
