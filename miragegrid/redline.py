...
def refuse_fielded_100(*, claimed: int | None = None, fielded: int | None = None) -> dict[str, Any]:
    """No fielded 100. Pool is 25. Cap-7 is 7."""
    n = fielded if fielded is not None else claimed
    if n == FIELDED_100 or claimed == FIELDED_100 or fielded == FIELDED_100:
        return _verdict(
            False,
            "AZG-NO-FIELDED-100",
            verdict=REFUSE,
    ...
    return _verdict(
        ...
        extra={"fielded_100": False, "pool": POOL_SIZE, "cap": CAP_7},
    )
...
def sim_fielded_100() -> dict[str, Any]:
    hit = refuse_fielded_100(fielded=100)
